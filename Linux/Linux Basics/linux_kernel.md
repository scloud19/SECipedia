...
Kernel
    In Linux, the kernel is usually found in /vmlinuz or /boot/vmlinuz
        A boot loader loaders this file into memory and starts the kernel when the system boots.
            Once this occurs, the main kernel file is no longer used by the running system.  

            Loadable Kernel Modules
                there are many modules that the kernel can load/unload on demand during the course of normal system operation.  
